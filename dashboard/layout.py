...
layout = dbc.Container([
    ...
    children=[
        ...
        dcc.Tab(
            ...
            value='tab-file-selector',
            children=[
                html.H4("Data Filters", style={'margin-bottom': '20px'}),
                            ...
                            [
                                ...
                                dbc.Row(
                                    [
                                        dbc.Col(
                                            [
                                                html.Label("Year(s):", style={'font-weight': 'bold'}),
                                                dcc.Dropdown(
                                                    id='year-selector',
                                        ...
                                        dbc.Col(
                                            [
                                                html.Label("DOY(s):", style={'font-weight': 'bold'}),
                                                dcc.Dropdown(
                                                    id='doy-selector',
                                                    options=[],  # Populated via callback
                                                    value=[],
                                        ...
                                        dbc.Col(
                                            [
                                                html.Label("Station(s):", style={'font-weight': 'bold'}),
                                                dcc.Dropdown(
                                                    id='station-selector',
                                                    options=[],  # Populated via callback
                                                    value=[],
                                ...
                                html.Label("Select PRNs:", style={'font-weight': 'bold', 'margin-bottom': '10px', 'display': 'block'}),
                                html.Div(
                                ...
                                html.Hr(),
                                html.H4("Selected Datasets", style={'margin-bottom': '10px'}),
        ...
        #                         # Residual Selector Dropdown (in Data Summary Tab)
        #                         html.Label("Select Residual:"),
        #                         dcc.Dropdown(
        #                             id='data-summary-residual-selector',
        #                             options=[],  # Populated via callback
        #                             value=None,  # Default residual (will be set via callback)
        #                             multi=False,
        #                             style={'color': '#000000', 'margin-bottom': '20px'}
        #                         ),

        #                         # Residual Type Selector (in Data Configuration Panel)
        #                         html.Label("Select Residual Type:"),
        #                         dcc.Dropdown(
        #                             id='residual-type-selector',
        #                             options=[],  # Populated via callback
        #                             value=None,  # Default value set via callback
        #                             multi=False,
        #                             style={'color': '#000000'}
        #                         ),
